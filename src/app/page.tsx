...
export default function HomePage() {
  return (
    <Layout>
      <div className="py-12">
        {/* Hero Section */}
        <div className="mx-auto bg-lightCard dark:bg-darkCard rounded-lg max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center p-8 shadow-lg ">
            ...
            <p className="mx-auto mt-3 max-w-md text-lg text-lightText sm:text-xl md:mt-5 md:max-w-3xl dark:text-darkText">
            ...
            <div className="mt-10 flex justify-center">
              <div className="rounded-md shadow">
                <Link
                  href="/auth/register"
                  className="flex w-full items-center justify-center rounded-md border border-transparent bg-blue-600 px-8 py-3 text-base font-medium text-darkText hover:bg-blue-700 md:px-10 md:py-4 md:text-lg"
                >
                  Start Now - It&apos;s Free!
                </Link>
              </div>
              <div className="ml-3 rounded-md shadow">
                <Link
                  href="/auth/login"
                  className="flex w-full items-center justify-center rounded-md border border-transparent bg-white px-8 py-3 text-base font-medium dark:text-zinc-300 hover:bg-gray-50 md:px-10 md:py-4 md:text-lg dark:bg-darkButton dark:hover:bg-zinc-800"
                >
                  Login
                </Link>
              </div>
        ...
        <div className="bg-lightCard dark:bg-darkCard mt-10 rounded-lg py-12 shadow-lg">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="lg:text-center">
              ...
              <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-lightText sm:text-4xl dark:text-darkText">
...
<div className="flex">
  ...
  <div className="ml-4">
    <h3 className="text-lg leading-6 font-medium text-lightText dark:text-darkText">
      ...
      Your tasks are always within reach.
        ...
        <div className="mt-10 rounded-lg bg-blue-600 shadow-lg dark:bg-blue-700">
          <div className="mx-auto max-w-2xl px-4 py-16 text-center sm:px-6 sm:py-20 lg:px-8">
            <h2 className="text-3xl font-extrabold text-darkText sm:text-4xl">
              <span className="block">Ready to get organized?</span>
              <span className="block">Start using Tarevity today.</span>
            </h2>
            <p className="mt-4 text-lg leading-6 text-darkText/80">
