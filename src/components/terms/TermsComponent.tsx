    ...
    <div className="mx-auto max-w-4xl px-6 py-8">
      ...
      <div className="dark:bg-BlackLight mb-8 overflow-hidden rounded-lg bg-white shadow-md">
        <div className="p-6">
          ...
          <p className="mb-4 text-gray-700 dark:text-gray-300">
            ...
            (&quot;you&quot;) and Tarevity (&quot;we,&quot; &quot;us&quot; or
            &quot;our&quot;), concerning your access to and use of the Tarevity
            task management application.
          </p>
          <p className="mb-4 text-gray-700 dark:text-gray-300">
            By accessing or using the application, you agree to be bound by
            these Terms of Use. If you disagree with any part of the terms, you
      ...
      <div className="dark:bg-BlackLight mb-8 overflow-hidden rounded-lg bg-white shadow-md">
        <div className="p-6">
          ...
          <p className="mb-4 text-gray-700 dark:text-gray-300">
            ...
            functionality are and will remain the exclusive property of Tarevity
            and its licensors. The application is protected by copyright,
          ...
          <p className="mb-4 text-gray-700 dark:text-gray-300">
            ...
            hold in the content you create and store on Tarevity. By uploading
            content to Tarevity, you grant us a worldwide, non-exclusive,
            royalty-free license to use, reproduce, adapt, publish, translate,
            and distribute your content in any existing or future media. This
            license is for the purpose of operating and improving our services
            only.
          </p>
        </div>
      </div>
      ...
      <div className="dark:bg-BlackLight mb-8 overflow-hidden rounded-lg bg-white shadow-md">
        <div className="p-6">
          ...
          <ul className="mb-4 list-disc pl-6 text-gray-700 dark:text-gray-300">
            ...
            <li className="mb-2">
              To impersonate or attempt to impersonate Tarevity, a Tarevity
              employee, another user, or any other person or entity.
            </li>
            <li className="mb-2">
              To engage in any other conduct that restricts or inhibits
              anyone&apos;s use or enjoyment of the application, or which, as
              determined by us, may harm Tarevity or users of the application,
      ...
      <div className="dark:bg-BlackLight mb-8 overflow-hidden rounded-lg bg-white shadow-md">
        <div className="p-6">
          ...
          <p className="mb-4 text-gray-700 dark:text-gray-300">
            Our application allows you to create, store, and share content such
            as tasks, descriptions, and other materials (collectively,
          ...
          <ul className="mb-4 list-disc pl-6 text-gray-700 dark:text-gray-300">
            <li className="mb-2">
              ...
              permissions to use and authorize us to use all intellectual
              property rights in and to any User Content.
            </li>
            <li className="mb-2">
              Your User Content does not violate the privacy rights, publicity
              rights, copyrights, contractual rights, intellectual property
              rights, or any other rights of any person or entity.
            </li>
            <li className="mb-2">
              Your User Content does not contain any material that solicits
              personal information from anyone under the age of 18 or exploits
              people under the age of 18 in a sexual or violent manner.
            </li>
            <li className="mb-2">
              Your User Content does not violate any applicable law concerning
      ...
      <div className="dark:bg-BlackLight mb-8 overflow-hidden rounded-lg bg-white shadow-md">
        <div className="p-6">
          ...
          <p className="mb-4 text-gray-700 dark:text-gray-300">
            ...
            services that are not owned or controlled by Tarevity.
          </p>
          <p className="mb-4 text-gray-700 dark:text-gray-300">
            Tarevity has no control over, and assumes no responsibility for, the
            content, privacy policies, or practices of any third-party websites
            or services. You further acknowledge and agree that Tarevity shall
      ...
      <div className="dark:bg-BlackLight mb-8 overflow-hidden rounded-lg bg-white shadow-md">
        <div className="p-6">
          ...
          <p className="mb-4 text-gray-700 dark:text-gray-300">
            ...
            application immediately, without prior notice or liability, under
            our sole discretion, for any reason whatsoever and without
            limitation, including but not limited to a breach of the Terms.
          </p>
          <p className="mb-4 text-gray-700 dark:text-gray-300">
            If you wish to terminate your account, you may simply discontinue
            using the application or request account deletion through the
      ...
      <div className="dark:bg-BlackLight mb-8 overflow-hidden rounded-lg bg-white shadow-md">
        <div className="p-6">
          ...
          <p className="mb-4 text-gray-700 dark:text-gray-300">
            Tarevity, its subsidiaries, affiliates, and its licensors do not
            warrant that a) the application will function uninterrupted, secure,
            or available at any particular time or location; b) any errors or
            defects will be corrected; c) the application is free of viruses or
            other harmful components; or d) the results of using the application
      ...
      <div className="dark:bg-BlackLight mb-8 overflow-hidden rounded-lg bg-white shadow-md">
        <div className="p-6">
          ...
          <p className="mb-4 text-gray-700 dark:text-gray-300">
            In no event shall Tarevity, nor its directors, employees, partners,
      ...
      <div className="dark:bg-BlackLight mb-8 overflow-hidden rounded-lg bg-white shadow-md">
        <div className="p-6">
          ...
          <p className="mb-4 text-gray-700 dark:text-gray-300">
            ...
            these Terms at any time. We will provide notice of changes to these
            Terms by posting the updated terms on the application with the
            &quot;Last updated&quot; date revised accordingly. What constitutes
      ...
      <div className="dark:bg-BlackLight mb-8 overflow-hidden rounded-lg bg-white shadow-md">
        <div className="p-6">
          ...
          <p className="mb-4 text-gray-700 dark:text-gray-300">
            ...
            laws of Europe, without regard to its conflict of law provisions.
          </p>
          <p className="mb-4 text-gray-700 dark:text-gray-300">
