...
const TodoStats = memo(
    ...
    return (
      <div className="mb-6 grid grid-cols-1 gap-6 md:grid-cols-3">
        <div className="rounded-lg p-4">
          ...
          <div
            className="mb-4 flex h-30 gap-10"
  ...
  (prevProps, nextProps) => {
    return (
      ...
      prevProps.pieSegments.active.dasharray ===
        nextProps.pieSegments.active.dasharray &&
      prevProps.pieSegments.completed.dasharray ===
        nextProps.pieSegments.completed.dasharray &&
      prevProps.pieSegments.review.dasharray ===
        nextProps.pieSegments.review.dasharray
    )
  },
)
